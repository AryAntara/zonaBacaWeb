<script type="module">
  ...
  const loginHandle = async() =>{
    if(username == '' && password == ''){
        //console.log('username ga Boleh kosong')
    }else{
...
const submitKontent = async() =>{
  ...
  //console.log(io)
  const socket = io.connect(`ws://${serverWebSocket}:3000`,{port:3000})
...
<div>
    ...
    <div class="container">
      ...
      <p class="indent">lupa password ? tidak ada opsi.</p>
      <h3> atau </h3>
    ...
    <div class="container">
      ...
      <p class="indent">lupa password ? <a href="">bikin baru aja.</a></p>
      <h3> atau </h3>
...
<center>
  ...
  <div class="content-container">
    ...
    {#if i.category == "study"}
    <div on:click={viewHandle(i.idToken)} class="content" style="background-color:#ccffff">
      <h3>{i.title}</h3>
      <p class="title">dibuat oleh {i.owner}</p>
      <p class="contents" >{i.content.slice(0,97)}...</p>
    </div> 
    {:else if i.category == 'information'}
    <div on:click={viewHandle(i.idToken)} class="content" style="background-color:#ffff00">
      <h3>{i.title}</h3>
      <p class="title">dibuat oleh {i.owner}</p>
      <p class="contents" >{i.content.slice(0,97)}...</p>
    </div>
    {:else if i.category == 'fun'}
    <div on:click={viewHandle(i.idToken)} class="content" style="background-color:#c9a0ff">
      <h3>{i.title}</h3>
      <p class="title">dibuat oleh {i.owner}</p>
      <p class="contents" >{i.content.slice(0,97)}...</p>
    </div>
...
{/if}
  ...
  <tr>
    <td>Konten</td> 
    <td><p class="info">* tips enter 2 kali untuk baris baru dan konten minimal 100 karakter.</p><textarea bind:value={isiKonten}></textarea></td>
  </tr>
  </table>
